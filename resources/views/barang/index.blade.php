    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="mb-0 theme-text-secondary">
                Daftar seluruh barang / aset kelas yang terdata.
            </p>
        </div>
                ...
                <table class="table theme-table table-hover align-middle mb-0">
                    ...
                    <thead>
                        <tr class="border-bottom theme-border">
                            <th scope="col" class="ps-4 theme-text-secondary" style="width: 50px;">
                                NO
                            </th>
                            ...
                            <th scope="col" class="text-end pe-4 theme-text-secondary">
                                AKSI
                            </th>
                        </tr>
                    </thead>
                        ...
                        @forelse($barangs as $item)
                            ...
                            <tr class="border-bottom theme-border">
                                ...
                                <td class="fw-semibold theme-text-secondary">
                                    {{ $item->kode_barang ?: 'BRG-' . str_pad($item->id_barang ?? $item->id, 4, '0', STR_PAD_LEFT) }}
                                </td>
                                ...
                                <td class="text-end pe-4">
                                    ...
                                    @if(Auth::check() && Auth::user()->role === 'admin')
                                        ...
                                        <a
                                            href="{{ route('barang.edit', $item->id_barang ?? $item->id) }}"
                                        ...
                                        <form
                                            action="{{ route('barang.destroy', $item->id_barang ?? $item->id) }}"
                                            method="POST"
                                            class="d-inline"
