...
<div class="container-fluid px-0">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
    <div>
      <h3 class="fw-bold mb-1 theme-text-primary">Laporkan Kerusakan</h3>
      <p class="mb-0 theme-text-secondary">Laporkan kerusakan barang / aset kelas.</p>
    </div>
