    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <p class="mb-0 theme-text-secondary">
                Daftar seluruh kategori yang terdata.
            </p>
        </div>
                ...
                <table class="table theme-table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        @forelse($kategori as $item)
                            ...
                            <tr class="border-bottom theme-border">
                                ...
                                <td class="fw-bold theme-text-primary">
                                    <span class="badge theme-badge-kategori">
                                        {{ $item->nama_kategori }}
                                    </span>
                                </td>
                        ...
                        @empty
                            ...
                            <tr>
                                <td colspan="3" class="text-center py-4 theme-text-secondary">
